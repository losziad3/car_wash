...
class Specialistpro extends StatefulWidget {
  ...
  @override
  State<Specialistpro> createState() => _SpecialistproState();
}

class _SpecialistproState extends State<Specialistpro> {
 ...
 final GovernorateList = ["Cairo", "Alex","Tanta"];
